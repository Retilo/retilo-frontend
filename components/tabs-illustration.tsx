...
function BubbleTail() {
  ...
  return (
    ...
    >
      ...
      {/* No full-rect fill: a solid --ga-bg layer often mismatched the real parent (organic vs default) and read as a box behind the tail. */}
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "var(--ga-shell-radius, 1rem)",
          overflow: "hidden",
